...
3. The program will wait for you to paste the test data (if [TOTAL_PARTICLES] is not fulfilled). Go into the folder **collider/testset/** then open any file as a text and copy all the text then paste into your program instance. Press Enter.
